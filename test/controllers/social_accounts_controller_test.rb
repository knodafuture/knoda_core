...
class SocialAccountsControllerTest < ActionController::TestCase
  ...
  test "should create social_account" do
    assert_difference('SocialAccount.count') do
      post :create, social_account: { access_token: @social_account.access_token, access_token_secret: @social_account.access_token_secret, providerId: @social_account.providerId, providerName: @social_account.providerName, user_id: @social_account.user_id }
    end
  ...
  test "should update social_account" do
    patch :update, id: @social_account, social_account: { access_token: @social_account.access_token, access_token_secret: @social_account.access_token_secret, providerId: @social_account.providerId, providerName: @social_account.providerName, user_id: @social_account.user_id }
    assert_redirected_to social_account_path(assigns(:social_account))
  end
